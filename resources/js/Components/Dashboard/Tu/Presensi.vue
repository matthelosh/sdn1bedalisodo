...
const startDay = computed(() => {
    return dayjs(tahun.value + "-" + (bulan.value + 1) + "-01")
        .startOf("month")
        .day();
});
const days = computed(() => {
...
<template>
    <div class="wrapper">
        <div
            class="toolbar print:hidden flex items-center justify-between h-12 bg-slate-200 p-3 sticky top-0"
        >
            <h3 class="font-bold text-slate-700">
                Blanko Daftar Hadir Pegawai
            </h3>
            <div class="toolbar-items flex gap-2">
                <select
                    ...
                    @change="getAgendas()"
                >
                    <option v-for="(bln, b) in bulans" :key="b" :value="b">
                        {{ bln }}
                    </option>
                </select>
                <select
        ...
        <div class="cetak px-2" v-for="p of 5" :key="p">
            <div
                class="content p-4 bg-slate-50 print:bg-white sheet my-2 break-before-all break-inside-avoid-page"
            >
                <!-- <Kop /> -->
                <div
                    class="kop grid grid-cols-6 border-b border-b-double border-b-black border-b-6 pb-2"
                >
                    ...
                    <div class="col-span-4">
                        ...
                        <h3 class="text-center">
                            KOORDINATOR WILAYAH DINAS PENDIDIKAN KECAMATAN WAGIR
                        </h3>
                        ...
                        <p class="text-center">
                            ...
                            {{ page.props.sekolah.desa }}, Kec.
                            {{ page.props.sekolah.kecamatan }}, Kab.
                ...
                <div class="meta mt-4">
                    ...
                    <h3 class="text-center">
                        BULAN {{ bulans[bulan]?.toUpperCase() }} TAHUN
                        {{ tahun }}
                    </h3>
                ...
                <table class="w-full text-[.6rem]">
                    <thead>
                        <tr>
                            <th rowspan="2" class="border border-slate-500">
                                No
                            </th>
                            <th
                                rowspan="2"
                                class="border border-slate-500 w-[350px]"
                            >
                                NAMA / NIP
                            </th>
                            <th
                                rowspan="2"
                                class="border border-slate-500 w-[150px]"
                            >
                                JABATAN
                            </th>
                            <th
                            ...
                            >
                                {{ haris[h] }}, {{ cals[p - 1][h] }}
                                <span v-if="cals[p - 1][h]"
                                    >{{ bulans[bulan] }} {{ tahun }}</span
                                >
                            </th>
                        </tr>
                        <tr>
                                ...
                                <th
                                    :class="
                                        ...
                                        isLibur(cals[p - 1][d])
                                            ...
                                            : 'bg-white'
                                    "
                                    class="border border-slate-500 w-[60px]"
                                    v-for="(l, i) in [
                                        'In',
                                        'TTD',
                                        'Out',
                                ...
                                <td
                                    :class="
                                        ...
                                        isLibur(cals[p - 1][d])
                                            ...
                                            : 'bg-white'
                                    "
                                    class="border border-slate-500 text-center"
                                    v-for="(l, i) in [
                                        'In',
                                        'TTD',
                                        'Out',
                ...
                <div class="ttd grid grid-cols-4 mt-4">
                    <div class="text-xs">
                        Keterangan:
                        <ul
                            class="text-xs list-decimal pl-4"
                            v-if="weekHasEvent(p - 1)"
                        >
                            <li v-for="ev in eventsPerWeek(p - 1)" :key="ev.id">
                                [{{ ev.start }} - {{ ev.end }}] {{ ev.name }}
                            </li>
                        </ul>
                    </div>
                    <div class="text-xs text-center">
                        ...
                        <p class="font-bold underline mt-12">
                            ABDUL MANAB, S.Pd.,MM
                        </p>
                    ...
                    <div class="text-xs text-center">
                        ...
                        <p class="font-bold underline mt-12">
                            Dr. JAYENG BUDI YUWONO PUTRO, S.Pd.,MA
                        </p>
                    ...
                    <div class="text-center text-xs">
                        ...
                        <p class="font-bold underline mt-12">
                            {{ page.props.sekolah.ks.nama }},
                            {{ page.props.sekolah.ks.gelar_belakang }}
                        </p>
