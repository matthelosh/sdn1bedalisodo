...
<template>
    <nav class="w-full md:w-3/4 mx-auto h-14 md:h-16  rounded-b-2xl md:rounded-none bg-white text-dark flex items-center justify-between p-3 md:p-8 fixed md:sticky top-0 z-40">
