...
const simpan = (content) => {
    console.log(content)
}
</script>

<template>
    <Head title="Halaman Error 404" />
    <div class="container">
        <div>
            <h1>
                <span>Error: File Halaman Login tidak ditemukan</span>
                <small>
                    <SvgIcon type="mdi" :path="mdiArrowLeft" />
                    <Link href="/">Kembali</Link>
                </small>
            </h1>
            <QEditor :text="content" @simpan="simpan" />
        </div>
    </div>
</template>
